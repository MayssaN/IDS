        ...
        t = {
            604: (e, t, n) => {
                ...
                function s(e, t) {
                    ...
                    for (var o in e)
                        if (o.substring(o.length - n.length, o.length) === n)
                            return e[o](t);
                    return !1;
                }
                function d(e, t) {
                    for (var n = [], o = e.parentNode.firstChild; o; )
                        1 === o.nodeType &&
                            o !== e &&
                            (void 0 !== t ? s(o, t) && n.push(o) : n.push(o)),
                            (o = o.nextSibling);
                    return n;
                }
                function c(e, t, n) {
                ...
                !(function () {
                    ...
                    o(g) || e || u(f);
                    T(),
                        c("click", ".js-lcc-settings-toggle", function () {
                            A();
                        }),
                                ...
                                return (
                                    e(r, [
                                        ...
                                        },
                                        {
                                            ...
                                            value: function (e) {
                                                var t =
                                                    this._inertManager.deregister(
                                                        e,
                                                        this
                                                    );
                                                t &&
                                                    this._managedNodes.delete(
                                                        t
                                                    );
                                            },
                                        },
                                        ...
                                        },
                                        {
                                            ...
                                            value: function (e) {
                                                var t =
                                                    this._inertManager.getInertRoot(
                                                        e
                                                    );
                                                t ||
                                                    (this._inertManager.setInert(
                                                        e,
                                                        !0
                                                    ),
                                                    (t =
                                            ...
                                            value: function (e, t) {
                                                if (t) {
                                                    ...
                                                    if (
                                                        ...
                                                        this._inertRoots.set(
                                                            e,
                                                            n
                                                        ),
                                                        !this._document.body.contains(
                                                            e
                                                        ))
                                                    )
                                                        for (
                    ...
                    function c(e, t, n) {
                        if (e.nodeType == Node.ELEMENT_NODE) {
                            ...
                            if ("content" == o.localName) {
                                for (
                                    var r = o,
                                        a = r.getDistributedNodes
                                            ? r.getDistributedNodes()
                                            : [],
                                        s = 0;
                                    s < a.length;
                                    s++
                        ...
                        for (var h = e.firstChild; null != h; )
                            c(h, t, n), (h = h.nextSibling);
                    }
                    function u(e) {
                        if (
                            !e.querySelector(
                                "style#inert-style, link#inert-style"
                            )
                        ) {
        ...
        (o.O = (t, n, i, r) => {
            if (!n) {
                ...
                for (u = 0; u < e.length; u++) {
                    for (var [n, i, r] = e[u], s = !0, d = 0; d < n.length; d++)
                        (!1 & r || a >= r) &&
                        Object.keys(o.O).every((e) => o.O[e](n[d]))
                            ? n.splice(d--, 1)
                            : ((s = !1), r < a && (a = r));
                    if (s) {
                        e.splice(u--, 1);
