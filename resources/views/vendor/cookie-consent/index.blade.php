...
<div role="dialog" aria-labelledby="lcc-modal-alert-label" aria-describedby="lcc-modal-alert-desc" aria-modal="true" class="lcc-modal lcc-modal--alert js-lcc-modal js-lcc-modal-alert" 
style="display: none;"
    ...
    <div class="lcc-modal__content">
        <div class="lcc-modal__content">
            ...
            <p id="lcc-modal-settings-desc" class="lcc-text">
                {!! trans('cookie-consent::texts.settings_text', [ 'policyUrl' => config("cookie-consent.policy_url")]) !!}
            </p>
...
<script type="text/javascript" src="{{ asset("mainassets2/js/main.js") }}"></script>